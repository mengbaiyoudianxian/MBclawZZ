...
data class ToolInfo(val id: Int, val name: String, val category: String, val summary: String, val tags: List<String>, val usage_count: Int, val parameters: Map<String, Any?>? = null, val enabled: Boolean = true, val runtime: String = "server")
